...
Try {
    ...
    [String]$appVendor = 'STARK'
    [String]$appName = 'OneDriveCleanup Tool'
    [String]$appVersion = '1.0'
    [String]$appArch = 'x86'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '13/11/2023'
    [String]$appScriptAuthor = 'Hans Christian Andersen'
    [String]$TenantID = "2e114308-14ec-4d77-b610-490324fa1844"
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        New-Folder -Path "C:\Temp\OneDriveCleanup" -ErrorAction Continue
        Copy-File -Path "$dirFiles\OneDriveKFMClean.ps1" -Destination "C:\Temp\OneDriveCleanup"
        Execute-ProcessAsUser -Path "$PSHOME\powershell.exe" -Parameters "-Command & { & `"C:\Temp\OneDriveCleanup\OneDriveKFMClean.ps1`"; Exit `$LastExitCode }" -Wait
